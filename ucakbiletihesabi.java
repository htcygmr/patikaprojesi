...
*/
        ...
        double ntutar,indirimliTutar,yasİndirimi,yTip2indirim;
        ...
        if (yolculukTipi==1)
        {
            if (yas<=12)
            {
                ...
                indirimliTutar=ntutar-yasİndirimi;
                System.out.print("12 yaşından küçükler için indirimli fiyatınız: "+indirimliTutar);
            ...
            else if ((yas>=12)&&(yas<=24))
            {
                ...
                indirimliTutar=ntutar-yasİndirimi;
                System.out.print("12-24 yaş arası için indirimli fiyatınız: "+indirimliTutar);
            ...
            else if (yas>=65)
            {
                ...
                indirimliTutar=ntutar-yasİndirimi;
                System.out.print("65 yaş üstü için indirimli fiyatınız: "+indirimliTutar);
        ...
        {
            yTip2indirim=ntutar*0.20;
            indirimliTutar=ntutar-yTip2indirim;
            System.out.print("Yolculuk Tipi 2 için indirimli fiyatınız: "+indirimliTutar);
